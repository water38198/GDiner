<template>
  <main class="container px-3 md:px-12.5 py-15">
    <div class="flex flex-col md:flex-row customBorder-xl rd-3 mb-20" data-aos="flip-left" data-aos-duration="1000">
      ...
      <div class="flex-1 p-6 md:p-10 border-(t-2 solid primary) md:border-(l-2 t-0)">
        <div class="flex flex-col justify-center h-100% ">
          <h2 class="font-size-10 mb-5">
            我們的願景
          </h2>
          <div class="mb-2.5">
            <p class="ltracking-widest">
