<template>
  <section class="mb-16" data-aos="flip-left">
    <div class="row custom-border custom-border-large overflow-hidden bg-primary">
      ...
      <div class="col-md-6 px-0 border-custom">
        <img
          ...
          alt="a picture of chef A-Gi" class="d-block w-100 h-100">
      </div>
    </div>
  </section>
  <section class="mb-16">
    <div class="row gy-6">
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
        <div class="custom-border custom-border-large pt-6 text-center h-100">
          ...
          <h5 class="fs-4 text-info">精心打造</h5>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
        <div class="custom-border custom-border-large pt-6 text-center h-100">
          ...
          <h5 class="fs-4 text-info">新鮮原料</h5>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="500">
        <div class="custom-border custom-border-large pt-6  text-center">
          ...
          <h5 class="fs-4 text-info">用心經營</h5>
