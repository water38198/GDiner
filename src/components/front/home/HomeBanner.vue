<template>
  <section class="mb-10 border-custom overflow-hidden" data-aos="fade-up">
    <div class="row">
      <div class="col-12 col-md-6">
        <div class="d-flex flex-column justify-content-center h-100 p-8">
          <h4 class="mb-4 fs-2 fs-sm-1 fw-bold">值得信任的阿橘<i class="bi bi-hand-thumbs-up-fill"></i></h4>
          <p>
            親愛的食客們，阿橘大廚受到法國、日本、韓國等各國料理啟發，每道料理都是阿橘精心研發、悉心呈現的絕佳組合，帶給您難忘的美食體驗。阿橘專注於每一道菜品的製作，並結合了傳統烹飪技藝和創新的烹飪理念，讓每一道菜都充滿了驚喜和美味。
          </p>
        </div>
      </div>
      <div class="col-12 col-md-6">
