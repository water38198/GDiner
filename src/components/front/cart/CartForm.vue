...
<template>
  <div class="py-10 px-4">
    ...
    <VForm class=" w-md-75 mx-auto" v-slot="{ errors }" @submit="submitOrder" autocomplete="off" ref="CartForm">
      <div class="row gy-4 gy-md-6">
        <h2 class="text-center">顧客資訊</h2>
        <div>
          <div class="form-floating">
            <VField type="email" name="Email" id="email" class="form-control border-custom" :class="{ 'is-invalid': errors['Email'] }"
        ...
        <div>
          <div class="form-floating">
            <VField type="address" name="地址" id="address" class="form-control border-custom" :class="{ 'is-invalid': errors['地址'] }" rules="required"
        ...
        <div>
          <div class="form-floating">
            <VField as="textarea" name="userForm.message" id="message" cols="30" rows="10" class="form-control border-custom"
